    ...
    return (
        <div className='flex flex-col w-screen min-h-screen bg-[#ffd6a5]  xl:h-screen  '>
            ...
            <div className='flex-1 grid place-items-center'>
                ...
                <div className='border rounded-lg m-5 mt-24 bg-[#FFFFFF] min-h-max w-5/6  p-5  sm:w-3/4 sm:px-5 lg:mt-10 lg:w-4/5 lg:h-4/6 2xl:w-3/5 '>
                    <p className=' text-2xl font-semibold  tracking-wider  my-5  '>About Us</p>
                    <div className='lg:flex lg:justify-center '>
                        <div className="text-gray-700 leading-relaxed lg:w-5/6 lg: my-5 ">Welcome to <span className='font-semibold text-red-500'>DonorCircle</span> a platform created to connect blood donors with those in need. We believe that a single donation can save multiple lives, and our mission is to make the
