    ...
    return (
        <div className='flex flex-col w-screen min-h-screen bg-[#ffd6a5] xl:h-screen'>
            ...
            <div className='flex-1 grid place-items-center'>
                <div className='flex justify-center items-center rounded-lg bg-[#FFFFFF] border border-red-600 mt-24 mx-10  sm:min-h-max  sm:w-3/4 sm:px-5 lg:-ml-28 lg:mt-10 lg:w-4/5  2xl:w-3/5  '>
